...
return new class extends Migration
{
    ...
    {
        Schema::create('post_comment_pictures', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('post_comment_pictures',function(Blueprint $table){
        ...
        Schema::dropIfExists('post_comment_pictures');
    }
};
