    ...
    <div class="top-area">
        <ul class="main-menu">
            <li>
                <a href="#" title="">Hom</a>
                <ul>
                    <li><a href="{{ route('website.users.index') }}" title="">Home Social</a></li>
                    <li><a href="index2.html" title="">Home Social 2</a></li>
                    <li><a href="index-company.html" title="">Home Company</a></li>
                    <li><a href="landing.html" title="">Login page</a></li>
                    <li><a href="logout.html" title="">Logout Page</a></li>
            ...
            <li><span>Helper</span>
                <ul>
                    <li><a href="{{ route('website.users.index') }}" >All Users 66</a></li>
                    <li><a href="blog-grid-right-sidebar.html" title="">Blog with R-Sidebar</a></li>
                </ul>
            </li>
            <li>
        ...
        <ul class="setting-area">
            ...
            <li>
{{--                ---------------Start my created notification-----------------}}
{{--                <a href="{{ route('notifications.index') }}" title="Notification" data-ripple="">--}}
{{--                    <i class="ti-bell"></i>--}}
...
{{--                            @php--}}
{{--                                // Decode the data field to ensure it's an array--}}
{{--                               // $notificationData = json_decode($notification->data, true);--}}
{{--                            @endphp--}}
{{--                            <li>--}}
{{--                                <a href="{{ route('notifications.markAsRead', $notification->id) }}" title="">--}}
{{--                                    <img src="{{ $notificationData['image'] ?? 'default-image.jpg' }}" alt="">--}}
{{--                                    <div class="mesg-meta">--}}
{{--                                        <h6>{{ $notificationData['sender_name'] ?? 'Unknown' }}</h6>--}}
{{--                                        <span>{{ $notificationData['body'] ?? 'No body text available' }}</span>--}}
...
{{--                        @endphp--}}
{{--                        <li>{{ $notificationData['body'] ?? 'No body text available' }}</li>--}}
{{--                    @endforeach--}}
{{--                </ul>--}}
...
{{--                        <li>--}}
{{--                            <h4>ID: {{ $notification->data['id'] }}</h4>--}}
{{--                            <a href="notifications.html" title="">--}}
{{--                                {{ $notification->data['post_body'] }}--}}
{{--                            </a>--}}
{{--                            <span class="tag blue">{{ $notification->data['post_body'] }}</span>--}}
{{--                        </li>--}}
{{--                    @empty--}}
...
{{--{{ ------------------------START MESSAGE --------------------------}}
            ...
            <li>
                ...
                <div class="dropdowns">
                    ...
                    <!-- Chat List -->
                    <ul class="drops-menu chat-list">
                        <!-- Example chat list item -->
                        <!-- The chat items will be dynamically generated using jQuery -->
                    </ul>
